...
* [Internal Bank Data](https://github.com/Sana-Parab/Credit-Risk-Modeling/blob/main/bank_data.xlsx): Customer account, payment history, and credit utilization, etc.
* [External CIBIL Data](https://github.com/Sana-Parab/Credit-Risk-Modeling/blob/main/cibil_data.xlsx): Historical credit scores and delinquency data, etc.

**Note**: The dataset comprised 50,000+ records, divided into 79 columns, the feature-target description you can see [here](https://github.com/Sana-Parab/Credit-Risk-Modeling/blob/main/Features_Target_Description.txt).
...
## Codes
- The Python Pipeline used for Data Cleaning and Preprocessing, Feature Engineering and Selection, Model training and Evaluation as well as Hyperparameter Tuning to find best ML Algorithm can be found [here](https://github.com/Sana-Parab/Credit-Risk-Modeling/blob/main/Notebook/credit_risk_modeling.ipynb).
- The Python Pipeline used to classify the prospects into 4 different categories of risk using **XGBoost Classfier** can be found [here](https://github.com/Sana-Parab/Credit-Risk-Modeling/blob/main/Notebook/credit_risk_pipeline.ipynb).
- The Python Pipeline used for final evaluation of model on unseen dataset can be found [here](https://github.com/Sana-Parab/Credit-Risk-Modeling/blob/main/Notebook/output_risk_pipeline.ipynb)
